...
const tweetList = [
    {
        iconName: 'icofont-twitter',
        desc: <p>Sumeet Mishra  <a href="#">@ShopCart Greetings! </a><br></br>  Grab your item, 50% Big Sale Offer !! <br></br></p>,
    },
    {
        iconName: 'icofont-twitter',
        desc: <p>Ankit Pathak  <a href="#">@ShopCart Hey!</a><br></br>   Grab your item, Minimum Selling Price Guarantee !!</p>,
    },
]
            ...
            <div className='footer-bottom'>
                <div className='container'>
                    <div className='section-wrapper'>
                        <p>&copy; 2024 <Link to="/">Shop Cart</Link> Designed by <a href='/' target='_blank'>Sumeet</a></p>
